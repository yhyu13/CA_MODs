...
using CA_EagleRisingSpecialPowers.SpecialPowers;
...
namespace CA_EagleRisingSpecialPowers
{
    internal class MyEquipmentMissionLogic : MissionLogic
    {
        ...
        private void Initialize()
        {
            ...
            {
                MyException.DisplayInGameConsole("Failed to load settings for CA_EagleRisingSpecialPowers.MyEquipmentMissionLogic!", ex);
            }
            ...
            {
                MyException.DisplayInGameConsole("Failed to init special powers for CA_EagleRisingSpecialPowers.MyEquipmentMissionLogic!", ex);
            }
        }
