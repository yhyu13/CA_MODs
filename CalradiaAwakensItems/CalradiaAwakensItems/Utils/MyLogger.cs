...
namespace CalradiaAwakensItems.Utils
{
    public static class MyLogger
    {
        ...
        public static void DisplayInGameConsole(string DisplayInGameConsoleInfo, string value = "")
        {
            ...
            {
                MBTextManager.SetTextVariable("CalradiaAwakensItems_VALUE", value, false);
                DisplayInGameConsoleInfo += "{CalradiaAwakensItems_VALUE}";
            }
            InformationManager.DisplayMessage(new InformationMessage(new TextObject(DisplayInGameConsoleInfo, null).ToString()));
        }
        ...
        public static void DisplayInGameConsole(string DisplayInGameConsoleInfo, Color color, string value = "")
        {
            ...
            InformationManager.DisplayMessage(new InformationMessage(new TextObject(DisplayInGameConsoleInfo, null).ToString(), color));
        }
    }
}
